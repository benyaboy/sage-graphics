...
#ifndef USER_INTERFACE_SERVER_CONCRETE_COMMAND_H
#define USER_INTERFACE_SERVER_CONCRETE_COMMAND_H
...
class UserInterfaceServerConcreteCommand : 
public UserInterfaceServerAbstractCommand {

public:

  // Constructor
  UserInterfaceServerConcreteCommand();

  // Constructor with pointer to instance of class Master
  UserInterfaceServerConcreteCommand(void* master);

  // Destructor
  virtual ~UserInterfaceServerConcreteCommand();
