...
#ifndef FL_OPACITY_TRANSFER_FUNCTION_H
#define FL_OPACITY_TRANSFER_FUNCTION_H
...
class Fl_Opacity_Transfer_Function : public Fl_Gl_Window {

public:

  // Constructor
  Fl_Opacity_Transfer_Function(int x, int y, int w, int h, const char* l = 0);

  // Destructor
  ~Fl_Opacity_Transfer_Function();
...
private:
  ...
  OpacityTransferFunctionWidget* _otfw;
