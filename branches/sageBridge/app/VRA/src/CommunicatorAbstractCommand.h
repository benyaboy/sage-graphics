...
#ifndef COMMUNICATOR_ABSTRACT_COMMAND_H
#define COMMUNICATOR_ABSTRACT_COMMAND_H

/*--------------------------------------------------------------------------*/

class CommunicatorAbstractCommand {

public:

  // Destructor
  virtual ~CommunicatorAbstractCommand();
