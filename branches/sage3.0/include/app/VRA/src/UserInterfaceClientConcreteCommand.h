...
#ifndef USER_INTERFACE_CLIENT_CONCRETE_COMMAND_H
#define USER_INTERFACE_CLIENT_CONCRETE_COMMAND_H
...
class UserInterfaceClientConcreteCommand : 
public UserInterfaceClientAbstractCommand {
...
public:
  ...
  // Constructor giving add message callback
  UserInterfaceClientConcreteCommand(void (*cb)(unsigned char* message));

  // Destructor
  virtual ~UserInterfaceClientConcreteCommand();
  ...
  // Set overview vertices function
...
private:
  ...
  void (*_addMessageCallback)(unsigned char* message);
